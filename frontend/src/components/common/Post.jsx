...
const Post = ({ post }) => {
  ...
  //delete post: isMyPost hardcoded need to get authenticated user
  ...
  const { mutate: deleteMutation, isPending: isDeleting } = useMutation({
    ...
    onSuccess: () => {
      ...
      //invalidate query to refetch the post data: helps with refreshing posts after deleting post then will remove post from UI also
  ...
  const { mutate: likeMutation, isPending:isLiking } = useMutation({
    ...
    onSuccess: (updatedLikes) => {
      ...
      //not best user experience UX invalidating here it refreshes every post instead of just a single post which is a better user experience: caching will be used instead of invalidatedQueries
      // queryClient.invalidateQueries({queryKey: ["posts"]})

      //updating cache directly for single posts
